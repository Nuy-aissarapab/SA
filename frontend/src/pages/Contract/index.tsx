...
function ContractPage() {
  const navigate = useNavigate(); //เขียนโค้ดนำทาง
  const location = useLocation(); //ดึงข้อมูล state ที่ส่งมาจากหน้าอื่น
  const shownRef = useRef(false); // เก็บสถานะการแสดงข้อความ
